...
//results: Matt's best day of the week is Monday

```
## Collections in Groovy
### Creating Lists and Sets
```
def l = [1, 3, 5, 7] // ArrayList by default
...
namesAndAges.find { it.age < 48 }.name //returns first element matching
```
...
namesAndAges.every { it.age < 48 } //true/false
```
...
namesAndAges.any { it.age < 48 } //true/false
```
